...
const TRANSITIONS: Record<string, string[]> = {
  ...
  IN_PROGRESS: ["WAITING_INFO", "WAITING_APPROVAL", "ESCALATED", "RESOLVED", "CANCELLED"],
  WAITING_INFO: ["IN_PROGRESS", "CANCELLED"],
  WAITING_APPROVAL: ["RESOLVED", "IN_PROGRESS", "CANCELLED"],
  ESCALATED: ["IN_PROGRESS", "CANCELLED"], // admin picks up
...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  "IN_PROGRESS->ESCALATED": ["MANAGER", "REGIONAL_DIRECTOR"],
