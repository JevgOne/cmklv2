...
export const alt = "Chci prodat auto — CarMakléř";
    ...
    (
      <OgLayout logo={logo}>
        <div style={{ display: "flex", fontSize: 48, fontWeight: 800, color: "white", textAlign: "center", lineHeight: 1.2 }}>
          <span>Prodejte auto </span>
          <span style={{ color: ORANGE, marginLeft: 14 }}>bez starostí</span>
        </div>
        <div style={{ display: "flex", fontSize: 22, color: "rgba(255,255,255,0.7)", marginTop: 20, textAlign: "center" }}>
          Ověřený makléř ve vašem okolí · Provize 5% · Vše zařídíme
        </div>
      </OgLayout>
    ),
    options,
