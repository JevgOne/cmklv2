...
export const alt = "Ojetá vozidla na prodej — prověřená auta od makléřů";
    ...
    (
      <OgLayout logo={logo}>
        <div style={{ display: "flex", fontSize: 48, fontWeight: 800, color: "white", textAlign: "center", lineHeight: 1.2 }}>
          <span>Prověřená ojetá </span>
          <span style={{ color: ORANGE, marginLeft: 14 }}>vozidla</span>
        </div>
        <div style={{ display: "flex", fontSize: 22, color: "rgba(255,255,255,0.7)", marginTop: 20, textAlign: "center" }}>
          Od ověřených makléřů i soukromých prodejců
        </div>
      </OgLayout>
    ),
    options,
