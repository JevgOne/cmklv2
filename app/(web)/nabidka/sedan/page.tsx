...
export const metadata: Metadata = bodyType ? {
  ...
  openGraph: {
    ...
    description: `Prověřené ojeté vozy sedan. Bezpečný nákup od makléřů.`,
  },
...
export default function Page() {
  ...
  return (
    <VehicleLandingPage
      ...
      description={bodyType.description}
      h1={`Ojeté vozy sedan`}
      filterDescription={`Prověřené ojeté vozy sedan od ověřených makléřů. Široký výběr značek a modelů.`}
