...
export const alt = "CarMakléř Shop — autodíly a příslušenství";
    ...
    (
      <OgLayout logo={logo}>
        <div style={{ display: "flex", fontSize: 48, fontWeight: 800, color: "white", textAlign: "center", lineHeight: 1.2 }}>
          <span>Autodíly a </span>
          <span style={{ color: ORANGE, marginLeft: 14 }}>příslušenství</span>
        </div>
        <div style={{ display: "flex", fontSize: 22, color: "rgba(255,255,255,0.7)", marginTop: 20, textAlign: "center" }}>
          Použité i nové díly · Záruka 6 měsíců · Doručení po celé ČR
        </div>
      </OgLayout>
    ),
    { ...size },
