...
export const alt = "Kolik stojí moje auto — CarMakléř";
    ...
    (
      <OgLayout logo={logo}>
        <div style={{ display: "flex", fontSize: 48, fontWeight: 800, color: "white", textAlign: "center", lineHeight: 1.2 }}>
          <span>Kolik stojí </span>
          <span style={{ color: ORANGE, marginLeft: 14 }}>moje auto?</span>
        </div>
        <div style={{ display: "flex", fontSize: 22, color: "rgba(255,255,255,0.7)", marginTop: 20, textAlign: "center" }}>
          Zjistěte tržní hodnotu vašeho vozu zdarma
        </div>
      </OgLayout>
    ),
    options,
