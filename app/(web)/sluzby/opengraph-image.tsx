...
export const alt = "CarMakléř — služby pro prodejce i kupce aut";
    ...
    (
      <OgLayout logo={logo}>
        <div style={{ display: "flex", fontSize: 48, fontWeight: 800, color: "white", textAlign: "center", lineHeight: 1.2 }}>
          ...
          <span style={{ color: ORANGE, marginLeft: 14 }}>prodejce i kupce</span>
        </div>
        <div style={{ display: "flex", fontSize: 22, color: "rgba(255,255,255,0.7)", marginTop: 20, textAlign: "center" }}>
          Prověrka VIN · Financování · Pojištění · Přepis vozu
        </div>
      </OgLayout>
    ),
    { ...size },
