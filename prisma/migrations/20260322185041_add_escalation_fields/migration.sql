/*
  ...
  - You are about to drop the column `priority` on the `Escalation` table. All the data in the column will be lost.
  - You are about to drop the column `subject` on the `Escalation` table. All the data in the column will be lost.
...
INSERT INTO "new_Escalation" ("brokerId", "createdAt", "description", "id", "managerId", "resolution", "resolvedAt", "status", "type", "updatedAt", "vehicleId") SELECT "brokerId", "createdAt", "description", "id", "managerId", "resolution", "resolvedAt", "status", "type", "updatedAt", "vehicleId" FROM "Escalation";
