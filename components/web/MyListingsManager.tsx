      ...
      {filtered.length === 0 ? (
        <div className="text-center py-20">
          ...
          <h3 className="text-xl font-bold text-gray-900">
            {activeTab === "all" ? "Zatím nemáte žádné inzeráty" : "Žádné inzeráty v této kategorii"}
          </h3>
          <p className="text-gray-500 mt-2">Vložte svůj první inzerát a začněte prodávat.</p>
          <Link href="/inzerce/pridat" className="inline-block mt-4 text-orange-500 font-semibold no-underline">
            Vložit inzerát &rarr;
          </Link>
        </div>
      ) : (
