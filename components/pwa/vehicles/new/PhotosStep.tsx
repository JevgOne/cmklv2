                ...
                return (
                  <div key={slot.id} className="relative">
                    {photo ? (
                      <Dropdown
                        trigger={
                          <div className="aspect-square rounded-xl overflow-hidden relative cursor-pointer border-2 border-green-500 hover:scale-[1.03] active:scale-95 transition-all duration-200">
                            <img
                      ...
                      <button
                        ...
                        className="w-full aspect-square rounded-xl bg-gray-50 border-2 border-dashed border-gray-200 flex flex-col items-center justify-center gap-1.5 cursor-pointer hover:bg-orange-50 hover:border-orange-300 hover:scale-[1.02] active:scale-95 transition-all duration-200"
                      >
                        ...
                        <span className="text-[9px] text-gray-400 leading-tight text-center px-0.5 font-medium">
                          {slot.label}
                        </span>
                      </button>
                    )}
