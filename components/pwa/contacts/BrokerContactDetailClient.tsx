...
interface BrokerContactDetailClientProps {
  initialData: ContactDetail;
}

export function BrokerContactDetailClient({ initialData }: BrokerContactDetailClientProps) {
  const router = useRouter();
  const [contact, setContact] = useState<ContactDetail>(initialData);
