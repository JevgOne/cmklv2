  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(data.error || "Smazani se nezdarilo");
      }
    } catch {
      setError("Chyba pripojeni, zkuste to znovu");
    } finally {
      setDeleting(false);
    }
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl p-6 max-w-sm w-full shadow-xl">
        <div className="text-center">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-1">Smazat dil?</h3>
          <p className="text-sm text-gray-500 mb-1">
            Opravdu chcete smazat <strong>&quot;{partName}&quot;</strong>?
          </p>
          <p className="text-xs text-gray-400 mb-5">
            Dil bude deaktivovan a nebude viditelny v katalogu.
          </p>
