...
interface MyPartsClientProps {
  initialParts: PartResult[];
  initialCounts: Record<string, number>;
}

export function MyPartsClient({ initialParts, initialCounts }: MyPartsClientProps) {
  const [activeTab, setActiveTab] = useState("all");
  const [parts, setParts] = useState<PartResult[]>(initialParts);
