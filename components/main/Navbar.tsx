...
const dropdownItems = {
  sluzby: [
    ...
    },
    {
      href: "/autoservisy",
      title: "Autoservisy",
      description: "Ověřené autoservisy s recenzemi zákazníků",
      icon: (
        <svg className="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    },
    {
      href: "/stk",
      title: "STK stanice",
      description: "Najděte nejbližší STK stanici s cenami",
      icon: (
        <svg className="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    {
      href: "/jak-prodat-auto",
      title: "Jak prodat auto",
      description: "Kompletní průvodce prodejem vozidla",
      icon: (
        <svg className="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  oNas: [
    ...
    },
    {
      href: "/makleri",
      title: "Naši makléři",
      description: "Najděte ověřeného makléře ve vašem okolí",
      icon: (
        <svg className="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    },
    {
      ...
      description: "Průvodce prodejem a nákupem přes makléře",
      icon: (
        <svg className="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    },
    {
      href: "/blog",
      title: "Blog",
      description: "Novinky, rady a analýzy ze světa aut",
      icon: (
        <svg className="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    },
    {
      href: "/kontakt",
      title: "Kontakt",
      description: "Ozvěte se nám, rádi pomůžeme",
      icon: (
        <svg className="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
