...
interface Props {
  initialLeads: PartnerLead[];
  initialTotal: number;
  initialTotalPages: number;
}

export function PartnerLeadsList({ initialLeads, initialTotal, initialTotalPages }: Props) {
  const [leads, setLeads] = useState<PartnerLead[]>(initialLeads);
