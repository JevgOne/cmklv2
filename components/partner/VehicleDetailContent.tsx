...
export function VehicleDetailContent({ initialVehicle }: { initialVehicle: VehicleDetail }) {
    ...
    <div className="max-w-2xl mx-auto">
      ...
      {editing ? (
        <div className="space-y-4">
          ...
          <Input label="Nájezd (km)" type="number" value={editMileage} onChange={(e) => setEditMileage(e.target.value)} />
          <Input label="Město" value={editCity} onChange={(e) => setEditCity(e.target.value)} />
          <Textarea label="Popis" value={editDescription} onChange={(e) => setEditDescription(e.target.value)} className="min-h-[100px]" />
